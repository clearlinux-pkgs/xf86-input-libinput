...
Source0  : https://www.x.org/releases/individual/driver/xf86-input-libinput-1.2.1.tar.xz
Source1  : https://www.x.org/releases/individual/driver/xf86-input-libinput-1.2.1.tar.xz.sig
...
%prep
%setup -q -n xf86-input-libinput-1.2.1
cd %{_builddir}/xf86-input-libinput-1.2.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643225986
...
cp %{_builddir}/xf86-input-libinput-1.2.1/COPYING %{buildroot}/usr/share/package-licenses/xf86-input-libinput/fa42615cf49e7d89b1e2008fe33ff6d00a9b0f5c
%make_install
