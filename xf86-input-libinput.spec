...
Source0  : https://www.x.org/releases/individual/driver/xf86-input-libinput-1.5.0.tar.xz
Source1  : https://www.x.org/releases/individual/driver/xf86-input-libinput-1.5.0.tar.xz.sig
...
%setup -q -n xf86-input-libinput-1.5.0
cd %{_builddir}/xf86-input-libinput-1.5.0
%patch -P 1 -p1
pushd ..
cp -a xf86-input-libinput-1.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729022911
